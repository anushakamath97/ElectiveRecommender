...
rnn_layer = SimpleRNN(20)(input_layer)#50 neurons (so length of st = 50)
output_layer = Dense(output_classes ,activation='relu')(rnn_layer)
...
for i in range(output_classes):
	targetData.append(np.zeros(19, dtype=np.int32))
	targetData[i][i] = 1
